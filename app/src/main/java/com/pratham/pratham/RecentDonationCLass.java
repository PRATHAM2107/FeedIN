...
public class RecentDonationCLass {
    private String donatedFrom, foodImage, foodName, foodStatus, requestedOn;

    public RecentDonationCLass() {
    }

    public RecentDonationCLass(String donatedFrom , String foodImage , String foodName , String foodStatus , String requestedOn) {
